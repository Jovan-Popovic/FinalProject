...
function loadRandomDrinks(){
    ...
    .then(data => {
        randomData = data;
        randomOutput = `
            <div id="item${counter}" class="item col-12 col-sm-12 col-md-6 col-lg-4" data-toggle="modal" data-target="#randomModal${counter}">
            ...
            `;
            randomModal = `
            <div class="modal fade" id="randomModal${counter}" tabindex="-1" role="dialog" aria-labelledby="randomModalScrollableTitle${counter}" aria-hidden="true">
              <div class="modal-dialog modal-dialog-scrollable" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="randomModalScrollableTitle${counter}">${randomData.drinks[0].strDrink}</h5>
